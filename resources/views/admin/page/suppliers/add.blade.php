                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-block">
                                                <textarea rows="4" class="form-control no-resize" placeholder="Mô tả cơ bản..."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-raised g-bg-cyan margin-right-3">Thêm mới</button>
